...
\*A note on data cleaning: Many survey questions were only added from
1995 onward, so observations before 1995 have a high number of missing
values. For these reasons, observations prior to 1995 were removed.
...
H0 (null hypothesis): An individual's political ideology (ideology),
...
HA (alternative hypothesis): An individual's political ideology
...
null hypothesis for the predictors ideology, cai, and godimportant, as
...
respectauthority and nationalpride, as the p-values for each level of
