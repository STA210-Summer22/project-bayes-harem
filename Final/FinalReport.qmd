...
Year of survey, Respect for Authority, and National Pride were made factors since <CHRISTINA EXPLAIN HERE>.  Political Ideology, Child Autonomy Index, and Importance of God had numerical sample spaces and were therefore treated as numerical variables.
  
*A brief note on data cleaning: Many survey questions were only added from 1995 onward, so observations before 1995 have a high number of missing values.  For these reasons, observations prior to 1995 were removed.*
...
We conducted a 75% - 25% data split into training and testing sets, using the random seed $206$. Fitting the MLR, we obtain the following table of parameter point estimates. 
