...
$$y ~=~ 8.5 ~+~ 0.029x_1 ~+~ 0.469x_2 ~-~ (0.284x_3 ~+~ 0.288x_4 ~+~ 0.19x_5)$$
  
where $x_1 ~=~ \text{year}$, $x_2 ~=~ \text{child autonomy index}$, $x_3 ~=~ \text{ideology}$, $x_4 ~=~ \text{god is important}$, and $x_5 ~=~ \text{respect for authority}$.
