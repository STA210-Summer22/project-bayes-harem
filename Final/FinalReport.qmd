...
plot_grid(h1, h2, h3, h4, h5, h6, ncol = 3, nrow = 2)
...
p0 <- ggplot(df, aes(x = term, y = estimate, ymin = conf.low, ymax = conf.high)) +
  geom_pointrange()
df
p0
```
