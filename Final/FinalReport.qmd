...
caption1 <- ggdraw() + 
  draw_label(
    "Fig.2: The visuals show that while some variables in the data set 
    have bell-shaped distributions, others are left-skewed.",
    x = 0,
    hjust = 0, 
    size = 8
  ) +
...
caption2 <- ggdraw() + 
  draw_label("Fig.3: The visuals show that there may be a relationship 
             between the response and each of these variables, 
...
ggpairs(abortion_data, 
  ...
  labs(title = "Correlation Matrix of Predictors of Interest", 
       caption = "Fig.4: This matrix shows that the correlations between 
       pairs of predictors are low, with the highest being 0.370.")
...
caption3 <- ggdraw() + 
  draw_label("Fig.5: 95% confidence intervals of estimates for model 
             parameters, using points and error bars.",
    x = 0,
    hjust = 0, size = 10
  ) +
  theme(
...
ggplot(metrics %>% filter(.metric == "rsq"),
    ...
    geom_point() +
    geom_line() +
    labs(title = "R-squared", caption = "Fig.6: This plot of R-squared 
         values demonstrates our chosen model 1 is the best of the three.")
```
...
final_table %>%
  kable(digits = 3, caption = "With the lowest AIC and BIC and highest 
        adjusted R-squared value, our chosen model is best of the three.")
```
...
caption4 <- ggdraw() + 
  draw_label("Fig.7: The linearity condition and constant variance condition 
             is clearly not met in this plot of residuals v. fitted values.",
    x = 0,
    hjust = 0, size = 8
  ) +
  theme(
...
caption5 <- ggdraw() + 
  draw_label("Fig.8: The residuals appear to follow a normal distribution, 
             which looks like a bell-shape, as illustrated in red.",
    x = 0,
    hjust = 0, size = 8
  ) +
  theme(
...
caption6 <- ggdraw() + 
  draw_label("Fig.9: The residuals plotted by observation order are randomly 
             scattered, showing no structure.",
    x = 0,
    hjust = 0, size = 8
  ) +
  theme(
